<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="MvcApplication1.Admin.Category" %>
     ...
     <form id="form1" runat="server">
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">    
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-12">
                                                    <div>
                                                        <label class="control-label">Doc type Category</label>
                                                        <asp:RadioButtonList ID="RbtnList" runat="server" RepeatDirection="Vertical" CellSpacing="150">
                                                            <asp:ListItem Value="0" Text="Gallery Category"></asp:ListItem>
                                                            <asp:ListItem Value="1" Text="Study Materials"></asp:ListItem>
                                                        </asp:RadioButtonList>
                        ...
                        <!-- Grid Values -->                                      
                          <asp:GridView ID="GrdCategory" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdCategory_PageIndexChanging" PagerSettings-Mode="Numeric" PageSize="10">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProgramsID" runat="server" Text='<%# Eval("CategoryID") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
