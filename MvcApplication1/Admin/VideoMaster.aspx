<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="VideoMaster.aspx.cs" Inherits="MvcApplication1.Admin.VideoMaster" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">    
                            ...
                            <div class="tab-pane" id="Userinfo" runat="server" visible="true">
                                <div class="portlet box blue">
                                     <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>Video Master
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <asp:TextBox ID="txtVideo" runat="server" CssClass="form-control" placeholder="Video Name"> </asp:TextBox>
                                                </div>
                                            </div>
                      ...
                      <!-- Grid Values -->                                      
                          <asp:GridView ID="GRDVideo" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GRDAudioVideo_PageIndexChanging" PagerSettings-Mode="Numeric" PageSize="10">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProgramsID" runat="server" Text='<%# Eval("AudioID") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
