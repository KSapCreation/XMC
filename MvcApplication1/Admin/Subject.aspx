<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="Subject.aspx.cs" Inherits="MvcApplication1.Admin.Subject" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">    
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div>
                                                        ...
                                                        <asp:TextBox ID="txtSubject" runat="server" CssClass="form-control" placeholder="Subject Name"> </asp:TextBox>
                       ...
                       <!-- Grid Values -->                                      
                          <asp:GridView ID="GrdSubject" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdSubject_PageIndexChanging" PagerSettings-Mode="Numeric" PageSize="10">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProgramsID" runat="server" Text='<%# Eval("SubjectID") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
