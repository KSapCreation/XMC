<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="ExamListMaster.aspx.cs" Inherits="MvcApplication1.Admin.ExamListMaster" %>
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">    
                            ...
                            <div class="tab-pane" id="Userinfo" runat="server" visible="true">
                                <div class="portlet box blue">
                                     <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>Exam List Master
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div>
                                                        ...
                                                        <asp:TextBox ID="txtExam" runat="server" CssClass="form-control" placeholder="Section Name"> </asp:TextBox>
                       ...
                       <!-- Grid Values -->                                      
                          <asp:GridView ID="GrdExamList" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdExamName_PageIndexChanging" PagerSettings-Mode="Numeric" PageSize="10">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProgramsID" runat="server" Text='<%# Eval("ExamID") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Exam Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSubjectName" runat="server" Text='<%# Eval("ExamName") %>' ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="pull-right hidden-xs">
                                        Project Completed <strong class="text-custom">55%</strong>.
                                    </div>
                                    <div>
