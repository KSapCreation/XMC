<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="Gallery.aspx.cs" Inherits="MvcApplication1.Admin.Gallery" ValidateRequest="false" %>
                     ...
                     <div class="tab-pane" id="Userinfo" runat="server" visible="true">
                         <div class="portlet box blue">
                             <div class="portlet-title">
                                 <div class="caption">
                                     <i class="fa fa-gift"></i>Gallery Collection
                                 </div>
                             </div>
                             <div class="portlet-body form">
                                 ...
                                 <div class="form-body">
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-md-4">
                                           ...
                                           <div class="col-md-2" id="EditImageDiv" runat="server" visible="false">
                                                    <asp:Image ID="imgEditFile" runat="server" Width="100px" BorderStyle="Groove" BorderColor="#000000"/>
                                               <asp:CheckBox ID="chkeditImage" runat="server" Text="Edit" CssClass="form-control" OnCheckedChanged="ImageEdition" AutoPostBack="true" />
                                               </div>
                                     </div>
                                     <div class="row">
                                         <div class="col-md-6">
                                             <div class="form-group">
                                                 ...
                                                 <asp:DropDownList ID="ddlTYpe" runat="server" CssClass="form-control" OnSelectedIndexChanged="DdlType" AutoPostBack="true">
                                                     <asp:ListItem Value="0" Text="Select"></asp:ListItem>
                                                     <asp:ListItem Value="1" Text="Picture"></asp:ListItem>
                                         ...
                                         <div class="col-md-6">
                                             <div class="form-group">
                                                 <label class="control-label">Name of Picture & Video</label>
                                     ...
                                     <div class="row">
                                         <div class="col-md-6" id="VideoUploader" runat="server">
                                             <div class="form-group">
                                                 <label class="control-label">Link</label>
                                                 <asp:TextBox ID="txtLink" runat="server" CssClass="form-control"></asp:TextBox>
                                             </div>
                                         </div>
                                         <div class="col-md-6" id="ImageUploader" runat="server" visible="false">
                                             <div class="form-group">
                                 ...
                                 <!-- END FORM-->
                                 <asp:GridView ID="GrdGallery" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdGallery_PageIndexChanging" PageSize="10">
                                     <Columns>
                                         <asp:TemplateField Visible="true" HeaderText="Gallery ID">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblProgramsID" runat="server" Text='<%# Eval("GalleryID") %>'></asp:Label>
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                        ...
                                        <asp:LinkButton ID="imgDelete" runat="server" OnClientClick="return confirm('Are you sure you want to delete this record?');" onclick="Delete"> <img src="FBNPC/images/delete.png" width="20px" alt="" /></asp:LinkButton>
                                         ...
                                         <asp:TemplateField HeaderText="Category Name">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblIsActive" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                                             </ItemTemplate>
                                         </asp:TemplateField>
