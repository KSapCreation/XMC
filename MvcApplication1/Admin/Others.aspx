<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="Others.aspx.cs" Inherits="MvcApplication1.Admin.Others" ValidateRequest="false" %>
        ...
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">                                         
                            <div class="tab-pane" id="Userinfo" runat="server" visible="true">
                                <div class="portlet box blue">
                                     <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>Others Information
                                            </div>
                                        </div>
                                         ...
                                         <div class="row">
                                               <div class="col-md-6">
                                                    <div>
                                                     ...
                                                     <asp:TextBox ID="txtID" runat="server" CssClass="form-control" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                                    </div>
                                                </div>    
                                                <div class="col-md-6">
                                                    <div>
                         ...
                         <!-- Grid Values -->    
                          ...
                          <asp:GridView ID="GrdOthers" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdOthers_PageIndexChanging" PageSize="10">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                 ...
                                 <asp:TemplateField Visible="true" HeaderText="Action">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="linkDelete" runat="server" OnClick="Delete" OnClientClick="return confirm('Are you sure you want to delete this record?');"> <img src="FBNPC/images/delete.png" width="20px" alt="" /> </asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
