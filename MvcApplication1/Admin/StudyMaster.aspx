<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="StudyMaster.aspx.cs" Inherits="MvcApplication1.Admin.StudyMaster" ValidateRequest="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>:: FBNPC Study Materials ::</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">    
                            ...
                            <div class="tab-pane" id="Userinfo" runat="server" visible="true">
                                <div class="portlet box blue">
                                     <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-gift"></i>Study Materials
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                             <div class="col-md-6">
                                                    <div>
                                                       ...
                                                       <asp:TextBox ID="txtBookTitle" runat="server" CssClass="form-control" placeholder="Book Title"> </asp:TextBox>

                                                    </div>
                                                </div>  
                                              <div class="col-md-6">
                                                    <div>
                                                        <label class="control-label">Short Information(Book)</label>
                                                       <asp:TextBox ID="txtShort" runat="server" CssClass="form-control" placeholder="Short Information"> </asp:TextBox>
                        ...
                        <!-- Grid Values -->                                      
                          <asp:GridView ID="GrdStudyBooks" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdStudyBooks_PageIndexChanging" PagerSettings-Mode="Numeric" PageSize="10">
                            <Columns>
                                <asp:TemplateField Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblProgramsID" runat="server" Text='<%# Eval("BookID") %>' Visible="false"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Book Name">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTitleName" runat="server" Text='<%# Eval("BookTitle") %>' ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Short Description">
                                    <ItemTemplate>
                                        <asp:Label ID="lblIsActive" runat="server" Text='<%# Eval("SortDesc") %>' ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
