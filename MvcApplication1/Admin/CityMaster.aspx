<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/FBNPC.Master" AutoEventWireup="true" CodeBehind="CityMaster.aspx.cs" Inherits="MvcApplication1.Admin.CityMaster" %>
        ...
        <asp:ScriptManager ID="scriptManager1" runat="server"></asp:ScriptManager>
                    ...
                    <div class="container">    
                        ...
                        <!-- Grid Values -->   
                          ...
                          <asp:GridView ID="GrdCity" runat="server" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-bordered table-hover" OnPageIndexChanging="GrdCity_PageIndexChanging" PagerSettings-Mode="Numeric" PageSize="10">
                            <Columns>
